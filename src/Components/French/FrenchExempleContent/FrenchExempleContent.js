...
import "../FrenchExempleContent/FrenchExempleContent.css";
import Example from "../../../media/portable.png"

export default function FrenchExempleContent () {
  return (
    <div>
      <h2 className="title-top">Exemples</h2>
      <div className="center">
        <img src={Example} alt="" className="example-pic"></img>
      </div>
      <p className="text">Nous avons créé des éléments en html pré-personnalisé, pour vous permettre d'avoir quelques éléments personnalisé très rapidement. Tous ces éléments sont responsive et s'adapterons a tout type d'écrans.</p>
