...
export default function FrenchColor () {
  return (
    <div className="ColorBloc">
      ...
      <div className="bloc-docu">
        ...
        <ul className="ul-docu">
          ...
          <li className="li-docu">.blue ( couleur bleu )</li>
          <li className="li-docu">.red ( couleur rouge )</li>
          <li className="li-docu">.crimson ( couleur crimson )</li>
