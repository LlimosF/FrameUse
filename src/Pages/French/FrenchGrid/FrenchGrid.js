...
export default function FrenchGrid () {
  return (
    <div className="ColorBloc">
      ...
      <div className="bloc-docu">
        ...
        <p className="font">
          Pour le responsive, nous vons proposons GRID CSS. Pour chaque largeur d'écran, nous avons crée des classes de 1 jusqu'à colonnes 
          pour maximiser la fléxibilité de grid et de vos envies.</p>
        <h2 className="bloc-title">Liste d'exemple</h2>
        <ul className="ul-docu">
          <li className="li-docu">.col11-1400 ( à 1400px de largeur d'écran, il y aura 11 colonnes. )</li>
          <li className="li-docu">.col8-800 ( à 800px de largeur d'écran, il y aura 8 colonnes. )</li>
          <li className="li-docu">.col6-1900 ( à 1900px de largeur d'écran, il y aura 6 colonnes.)</li>
          <li className="li-docu">.col2-600 ( à 600px de largeur d'écran, il y aura 2 colonnes. )</li>
          <li className="li-docu">.col7-1100 ( à 1100px de largeur d'écran, il y aura 7 colonnes. )</li>
        </ul>
        <h2 className="bloc-title">Explications</h2>
        <p className="font">
          On vous a écrit le maximum de " templates " possible, avec le minimum, et le maximum 
          de grille par taille d'écrans. Les tailles d'écran sont en largeur et vont de 
          300px à 2000px.</p>
